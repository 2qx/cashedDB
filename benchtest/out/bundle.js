...
document.addEventListener('DOMContentLoaded', function () {
    return __awaiter(this, void 0, void 0, function () {
        var dbWebWorker_1, startWorkerButton;
        return __generator(this, function (_a) {
            ...
            try {
                ...
                if (window.Worker) {
                    dbWebWorker_1 = new Worker("./cashedDbWorker.js", { type: "module" });
                    startWorkerButton = document.getElementById('startWorker');
                    startWorkerButton.onclick = function () {
                        dbWebWorker_1.postMessage({ command: 'init' });
                        console.log('Message posted to worker');
                    };
                    dbWebWorker_1.onmessage = function (e) {
